...
/*********************************************************************
** Description: Constructor initializes the xCoord and yCoord
**              class member.
** Parameters: Takes variables of values given by the
...
** Parameters: Takes values passed in by constant reference and returns
**				coordinate values. 
*********************************************************************/ 
