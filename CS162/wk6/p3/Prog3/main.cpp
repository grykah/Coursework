...
int main()
{
    ...
    Creature *set1[NUM_CREATURES] = { new HarryPotter(), new Barbarian(), new Medusa(), new BlueMen(), new Vampire() };
    Creature *set2[NUM_CREATURES] = { new HarryPotter(), new Barbarian(), new Medusa(), new BlueMen(), new Vampire() };
