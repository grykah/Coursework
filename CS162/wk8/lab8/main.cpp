 ...
 ** Date: 3/2/17
 ** Description: Displays menu for user to pick between linear search, 
 **              binary search, or bubblesort.
 ** Input: std::ifstream
 ** Output: std::ofstream
 *********************************************************************/
 ...
 **                 lists of integers
 ** Post-Conditions: user choice obeyed
 *********************************************************************/
 ...
 **              the given value and prints which indices contain the
 **              value (if any).
